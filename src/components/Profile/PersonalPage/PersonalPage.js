...
import { View, Text, ImageBackground, StyleSheet, Dimensions, Image, TextInput, ScrollView, StatusBar } from "react-native";
        ...
        <ScrollView style={AppStyle.StyleHome.scrollview}>
            ...
            <View style={AppStyle.StyleProfile.body}>
                <ScrollView style={AppStyle.StyleHome.scrollview}>
                    ...
                    <SeeIMG />
                    <TextHome text1={'Lịch trình của bạn'} text2={'Xem Thêm >'} onSeeMore={() => navigation.navigate("HomeStack", { screen: 'SeeMoreSchedule' })} />
