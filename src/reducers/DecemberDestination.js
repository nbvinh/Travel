  ...
  data: [
    {
      ...
      text: 'SaPa',
      text1: 'Lào Cai',
      img: 'https://viettrekking.vn/wp-content/uploads/2020/01/30097580257_5b7be918f6_c-1.jpg',
      name: 'SaPa - Nơi Có Tuyết',
      mapaddress: {
        latitude: 15.3798496,
      ...
      label: 'SaPa không chỉ được mệnh danh là “Vương quốc tỏi” mà còn có “Đảo ngọc” Cù Lao Ré. Sức hút của đảo Lý Sơn nằm ở chiến tích lịch sử lẫy lừng, ở những con người miền test tetstetetsttstsstststtstsstt',
      ScheduleOK: [
        {
          id: 0,
    ...
    },
    {
      ...
      text: 'Mộc Châu',
      text1: 'Sơn La',
      img: 'https://scontent.fhph1-1.fna.fbcdn.net/v/t1.15752-9/127517810_780271592555657_2549332519838602366_n.jpg?_nc_cat=102&ccb=1-3&_nc_sid=ae9488&_nc_ohc=H1zTVkHs6C8AX-yOZDY&_nc_ht=scontent.fhph1-1.fna&oh=68c0b2c2ef9e4c1954c3ab07747ed9eb&oe=60A64A81',
      name: 'Mộc Châu - Thành phố ven biển',
      mapaddress: {
        latitude: 12.259629,
    ...
    },
    {
      ...
      text: 'Tam Đảo',
      text1: 'Vĩnh Phúc',
      img: 'https://img.nhandan.com.vn/Files/Images/2021/02/20/3D-1613814306516.jpg',
      name: 'Tam Đảo - Đảo lớn nhất Việt Nam',
      mapaddress: {
        latitude: 10.2218584,
      ...
      label: 'Tam Đảo là hòn đảo lớn nhất Việt Nam, nằm trong vịnh Thái Lan. Đảo Phú Quốc cùng với các đảo nhỏ hơn ở lân cận và quần đảo Thổ Chu nằm cách đó 55 hải lý về phía tây nam hợp thành thành phố Phú Quốc thuộc tỉnh Kiên Giang. Đây cũng là thành phố đảo đầu tiên của Việt Nam.',
      ScheduleOK: [
        {
          id: 0,
          img1: 'https://cdn.vntrip.vn/cam-nang/wp-content/uploads/2018/01/kinh-nghiem-du-lich-da-lat-ban-can-luu-lai-15.jpg',
    ...
    },
    {
      ...
      text: 'Đồng Văn',
      text1: 'Hà Nam',
      img: 'https://wiki-travel.com.vn/Uploads/Post/anhvo2804-192002032042-dongvanlungcu.jpg',
      name: 'Đồng Văn -  Di sản Thiên nhiên Thế giới ',
      mapaddress: {
        latitude: 20.987077,
